...
NIFTI_ROOT = Path(r"G:\datasets3D\3d_data_3")
LABEL_ROOT = Path(r"G:\data3\labels")
OUTPUT_ROOT = Path(r"G:\datasets3D\nodule_patches96_3")
PATCH_SIZE_MM = 96  # Physical size in mm (before resampling)
TARGET_SPACING = (1.0, 1.0, 1.0)  # Target isotropic resolution
...
def resample_volume(image, new_spacing):
    """
    Resample the volume to isotropic resolution
    """
